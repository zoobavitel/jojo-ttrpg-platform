...
| [standard-ability-roll-bonus-audit.md](standard-ability-roll-bonus-audit.md) | Ability `+1d` / `+1 effect` UI rules, Parry counterattack follow-up, curated overrides |
