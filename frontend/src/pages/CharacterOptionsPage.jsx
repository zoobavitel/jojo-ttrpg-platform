    ...
    <div style={S.page}>
      <div style={S.content}>
        ...
        <section style={S.section}>
          ...
          >
            <div style={S.card}>
              ...
              >
                <Zap
                  style={{ width: 18, height: 18, color: TYPE_COLORS.stand }}
                />
              ...
              >
                Stands do not have a rigid playbook to follow—a Stand's form
                informs how it behaves, not what it can do. Players create
                Stands with a set amount of abilities (per SRD rules), choosing
                from standard abilities or unique abilities that follow the
                rules. The example builds below are optional—they encourage
            ...
            <div style={S.card}>
              ...
              >
                <BookOpen
                  style={{ width: 18, height: 18, color: TYPE_COLORS.hamon }}
                />
                <span style={{ fontWeight: "bold", fontSize: "14px" }}>
                  Hamon
                </span>
                <span style={S.tag(TYPE_COLORS.hamon)}>Hamon</span>
                <span style={S.tag("#6b7280")}>WIP</span>
              </div>
              <p
                style={{
                  fontSize: "12px",
            ...
            <div style={S.card}>
              ...
              >
                <Users
                  style={{ width: 18, height: 18, color: TYPE_COLORS.spin }}
                />
                <span style={{ fontWeight: "bold", fontSize: "14px" }}>
                  Spin
                </span>
        ...
        <section style={S.section}>
          ...
          >
            These are the allowed Stand types. Example builds show how each type
            can be realized—they are optional inspiration, not requirements.
          </p>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                {standTypes.map((t) => (
                  <div
                    key={t.id}
                    style={{ ...S.card, flex: "1 1 200px", minWidth: "180px" }}
                  >
                    <span style={{ fontWeight: "600", fontSize: "12px" }}>
                      {t.name}
                    </span>
                ...
                <div key={idx} style={S.card}>
                  ...
                  {expandedBuilds[idx] && (
                    ...
                    >
                      ...
                      {(build.recommended_standard_abilities || []).length >
                        0 && (
                        <div>
                          <div
                            style={{
                          ...
                          >
                            {build.recommended_standard_abilities.map(
                              (a, i) => (
                                <li key={i}>{a}</li>
                              ),
                            )}
        ...
        <section style={S.section}>
          ...
          <div style={S.card}>
            ...
            >
              <li>
                <strong>Choose a Playbook</strong> — Stand, Hamon, or Spin. Each
                has a unique narrative flavor and foundational abilities.
              </li>
              <li>
                <strong>Choose Your Heritage</strong> — Influences origins and
                innate capabilities. See Heritage Options above.
              </li>
              <li>
                <strong>Make a Background</strong> — Detail your previous life
                and how you joined the crew.
              </li>
              <li>
                <strong>Assign 7 Action Dots</strong> —{" "}
                {rules.action_dots?.description ||
                  "Distribute 7 action dots, max 2 per action."}
              </li>
              <li>
                <strong>Create Your Stand (or Hamon/Spin)</strong> — Define
                abilities and Coin stats. Stands use a set number of abilities
                (standard or unique per rules). Example builds are optional
                inspiration.
              </li>
              <li>
                <strong>Stand/Hamon/Spin Armor</strong> — Track special armor
                tied to your path.
              </li>
              <li>
                <strong>Close Friend and Rival</strong> — Pick one of each from
                your playbook.
              </li>
              <li>
                <strong>Choose Your Vice</strong> — Faith, Gambling, Luxury,
                Obligation, Pleasure, Stupor, or Weird.
              </li>
            </ol>
          </div>
          {rules.coin_stats && (
            <div style={{ ...S.card, marginTop: "8px" }}>
              ...
              >
                Grades:{" "}
                {rules.coin_stats.grades?.join(", ") || "F, D, C, B, A, S"}
              </p>
            </div>
          )}
          {rules.benefits_detriments && (
            <div style={{ ...S.card, marginTop: "8px" }}>
              ...
              >
                {rules.benefits_detriments.hp_budget}
              </p>
              <p
                style={{
                  fontSize: "12px",
              ...
              >
                {rules.benefits_detriments.required_selection}
              </p>
            </div>
          )}
        </section>
